...
local comandos = {
{nome = "/efetuar disparos x4", cmd = "|[+]| - Efetuar Disparos X4 - [M16] 5,56mm 'Head-Trick"},
{nome = "/coronhada", cmd = "|[+]| - Coronhada"},
{nome = "/rapel", cmd = "|[+]| - Rapel"},
{nome = "/rene", cmd = "|[+]| - Rene"},
{nome = "/rádio", cmd = "|[+]| - Rádio:"},
{nome = "/kit", cmd = "|[+]| - Kit"},
{nome = "/efetuar disparos x4", cmd = "|[+]| - Efetuar disparos X4 - [M16] 5,56 ' estoura pneu"},
{nome = "/desmaiar", cmd = "|[+]| - Desmaiar"},
{nome = "/pisar", cmd = "|[+] | - Pisar"},
}
